...
public class LeftBar_time {
    @FXML
    Rectangle hp_bar, map_rec;
    @FXML
    Label mag_lb, kill_lb, time_lb;
    @FXML
    Button pause_btn;
    @FXML
    ...
    public void initialize(){
        ...
        gun_type_lb.setPrefWidth(50);
        gun_type_lb.setPrefHeight(50);
    }
    ...
    public void bindTime_lb(){
        FirstScene.lastTime.addListener((t, oldV, newV)->{
            if(newV.intValue()<10) time_lb.setText("00:0"+newV);
            else time_lb.setText("00:"+newV);
        });
    }
